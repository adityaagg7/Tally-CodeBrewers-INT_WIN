...
button_find_large_files = tk.Button(window, text="Find Large Files", command=get_large_files)
# text_box = tk.Text(window, wrap=tk.WORD, width=80, height=15)  # Create the text box
button_delete = tk.Button(window, text="Delete Files", command=delete_items(list_2))
